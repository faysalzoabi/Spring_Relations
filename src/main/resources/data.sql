...
insert into User(id, firstname, lastname, email, locationid) values(4, 'faysal', 'zoabi', 'faysal@gmail.com', 1);
...
insert into Post(id, post_date, details, userid) values(4, CURRENT_TIMESTAMP(), 'another tuorials', 2);